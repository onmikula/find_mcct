...
#trees=nann; file="results/Nannomys_nyika.tree"; target=nyika; monophyletic=FALSE; method="mean"; return=TRUE; burnin=0; thinning=1; digits=2; hpd=0.95; figtree=FALSE
